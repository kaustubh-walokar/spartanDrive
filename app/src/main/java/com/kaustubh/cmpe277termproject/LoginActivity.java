...
Author: Arpit Khare
Date: 11/20/2015
Functionality: OAuth2 Google Sign In
 */
...
public class LoginActivity extends AppCompatActivity implements
    ...
    public void onfileButtonPress() {
        Intent fileActivityIntent = new Intent(getBaseContext(), MyFilePicker.class);
        /*
        Code to set the email id to be send to file manager
         */
        fileActivityIntent.putExtra(Constants.USERNAME, emailID);
